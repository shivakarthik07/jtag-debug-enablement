...
endtask
 ...
 task automatic jtag_write_ctrl;
    ...
    begin
        ...
        // shift bit0
        jtag_cycle(1'b0, ctrl[0], dummy);

        // shift bit1
        jtag_cycle(1'b0, ctrl[1], dummy);

        // shift bit2 and leave SHIFT_DR
        jtag_cycle(1'b1, ctrl[2], dummy);
